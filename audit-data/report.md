...
# About Naman Khandelwal

I am a blockchain security enthusiast with expertise in smart contract auditing. I specialize in identifying vulnerabilities, ensuring secure implementations, and providing actionable recommendations to improve code robustness. Passionate about decentralized systems, I focus on delivering high-quality audits and fostering trust in blockchain technology.

# Disclaimer

The Naman Khandelwal team makes all effort to find as many vulnerabilities in the code in the given time period, but holds no responsibilities for the the findings provided in this document. A security audit by the team is not an endorsement of the underlying business or product. The audit was time-boxed and the review of the code was solely on the security aspects of the solidity implementation of the contracts.
